...
var flag = 1; // 0 - m, 1 - pc
function macro(apiURL, serverName, bHeadless, delay, chromePath, maxTabNumber, bURLLoading) {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 7: return [4 /*yield*/, (0, axios_1.default)({
                        url: apiURL + "/working-url?type=2&urlType=" + (flag === 0 ? 'mobile' : 'pc') + "&tabNum=" + maxTabNumber,
                    })];
                case 8:
                    res = _b.sent();
                    ...
                    if (array_1 == undefined) {
                        // browser.close();
                        macro(apiURL, serverName, bHeadless, delay, chromePath, maxTabNumber, bURLLoading);
                        return [2 /*return*/];
                    }
                    cnt_1 = 0;
                    i_1 = 0;
                    console.log("작업블로그 갯수 - " + array_1.length + " type - " + (flag === 0 ? 'mobile' : 'pc'));
                ...
                case 11:
                    i_2++;
                    return [3 /*break*/, 9];
                case 12: return [4 /*yield*/, sleep(500)];
                case 13:
                    _b.sent();
                    flag = flag === 0 ? 1 : 0;
                    macro(apiURL, serverName, bHeadless, delay, chromePath, maxTabNumber, bURLLoading);
                ...
                case 16:
                    ...
                    firstURL_1 = flag === 0 ? 'https://m.blog.naver.com/' + orgURL_1.split('naver.com/')[1]
                        : 'https://blog.naver.com/' + orgURL_1.split('naver.com/')[1];
                    return [3 /*break*/, 18];
                case 17:
                    e_1 = _b.sent();
                    console.log(e_1);
                                ...
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        ...
                                        case 3:
                                            ...
                                            working.url = working.link.split('blog.naver.com/')[1];
                                            if (working.url.includes('/'))
                                                working.url = working.url.split('/')[0];
                                            //      working.url = flag === 0 ? 'https://m.blog.naver.com/PostSearchList.naver?blogId='+working.url :
                                            //        'https://blog.naver.com/profile/intro.naver?blogId='+working.url;
                                            working.url = flag === 0 ? 'https://m.blog.naver.com/' + working.url
                                                : 'https://blog.naver.com/' + working.url;
                                        ...
                                        return [4 /*yield*/, (0, axios_1.default)({
                                                ...
                                                method: 'PATCH',
                                                data: {
                                                    idx: working.traffic_idx,
                                                    type: 2,
                                                    urlType: flag === 0 ? 'mobile' : 'pc',
                                                }
                                            })];
                                        case 7:
                                            // await page.waitFor(getRandomInt(100, 150));
                                        ...
                                        case 8:
                                            ...
                                            pages.push(page);
                                            cnt_1++;
                                            if (!(cnt_1 === (maxTabNumber < array_1.length ? maxTabNumber : array_1.length))) return [3 /*break*/, 19];
                                            if (!!firstPage.isClosed()) return [3 /*break*/, 10];
                                        ...
                                        case 10:
                                            ...
                                            _a.label = 11;
                                        case 11:
                                            if (!(i_3 < pages.length)) return [3 /*break*/, 14];
                                            if (!!pages[i_3].isClosed()) return [3 /*break*/, 13];
                                        ...
                                        case 14:
                                            ...
                                            _a.label = 15;
                                        case 15:
                                            if (!(i_4 < pages.length)) return [3 /*break*/, 18];
